        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="flex-shrink-0">
            {/* <a 
              ...
              aria-label="Mangrish Homepage"
            >
              Mangrish
            </a> */}
            <Link to="/" className="md:flex items-center pl-0">
              <img
                src={company_logo}
                alt="logo"
                className="h-[24px] md:h-[56px]"
              />
              <h6 className="text-xl px-5 font-semibold text-sky-950">
                Mangrish
              </h6>
            </Link>
          </div>
          ...
          >
            <a
              ...
              className={`font-medium transition-colors duration-200 px-3 py-2 rounded-md ${
                activeMenu === "Home"
                  ? "bg-blue-50 text-blue-600" // Active state styles
                  : "text-gray-700 hover:text-blue-600 hover:bg-gray-50" // Default/hover state
              }`}
            ...
            >
              <button
                className="text-gray-700 hover:text-blue-600 font-medium transition-colors duration-200 px-3 py-2 rounded-md hover:bg-gray-50 flex items-center"
          ...
          <div className="flex items-center space-x-4">
            <a
              ...
              className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-6 py-2 rounded-lg font-medium hover:from-blue-700 hover:to-cyan-700 transform hover:scale-105 transition-all duration-200 shadow-md hover:shadow-lg"
            >
              Contact Us
            </a>
